...
public class HammerController02 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        rotationA = rotationInicial * Quaternion.Euler(0, 0, 90); //Rota 45 a la derecha
        rotationB = rotationInicial * Quaternion.Euler(0, 0, 0); //Rota 45 a la izquierda
    }
